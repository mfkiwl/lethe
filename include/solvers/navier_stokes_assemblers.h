...
template <int dim>
class ArtificialCompressibilityNavierStokesAssemblerCore
  : public NavierStokesAssemblerBase<dim>
{
public:
  ArtificialCompressibilityNavierStokesAssemblerCore(
    std::shared_ptr<SimulationControl> simulation_control)
    : simulation_control(simulation_control)
  {}
 ...
 */
template <int dim>
class ArtificialCompressibilityNavierStokesAssemblerBDF
  : public NavierStokesAssemblerBase<dim>
{
public:
  ArtificialCompressibilityNavierStokesAssemblerBDF(
    std::shared_ptr<SimulationControl> simulation_control,
    const double                       compressibility_coefficient)
    : simulation_control(simulation_control)
    , artificial_compressibility_coefficient(compressibility_coefficient)
  {}
  ...
  std::shared_ptr<SimulationControl> simulation_control;
  const double                       artificial_compressibility_coefficient;
};
